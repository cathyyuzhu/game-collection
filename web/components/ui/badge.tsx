  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors",
  {
    variants: {
      variant: {
        ...
        primary: "border-transparent bg-brand-purple/15 text-brand-purpleDark dark:text-brand-purple",
        ...
        purple: "border-transparent bg-gradient-to-r from-brand-purple to-brand-pink text-white"
      }
    },
